...
const Contact = () => {
    return (
        <section id="contact" className="min-h-screen bg-black text-white relative overflow-hidden flex flex-col justify-between py-20 px-4">
            ...
            <div className="max-w-6xl mx-auto w-full relative z-10 flex-grow flex flex-col justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <h1 className="text-[15vw] md:text-[10vw] font-black leading-none tracking-tighter mb-4 text-white select-none drop-shadow-[0_0_20px_rgba(0,180,255,0.4)]">
                            Ayushhh
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-400 font-mono mb-8">
                            <span className="text-electric-blue">&gt;</span> your friendly chaos creator
                        </p>
            ...
            <div className="max-w-6xl mx-auto w-full border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-mono text-gray-600 relative z-10">
                <div className="flex gap-6">
                    <a href="https://github.com/b423016" className="hover:text-white transition-colors">GITHUB_REPO</a>
                    <a href="#" className="hover:text-white transition-colors">LINKEDIN_PROFILE</a>
                    <a href="#" className="hover:text-white transition-colors">TWITTER_FEED</a>
                </div>
                <div>
                    SYSTEM_ID: PORTFOLIO_V1 // © 2026 AYUSH KUMAR JHA
                </div>
            </div>
        </section>
    );
